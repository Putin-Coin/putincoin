...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees, uint256 prevHash)
{
    ...
    int rand = generateMTRandom(seed, 500);
                                                                                   
	if (nHeight <= 0)
        nSubsidy = 0;
        else if (nHeight <= 10 )
        nSubsidy = 0 * COIN;      // FIRST 10 BLOCKS FOR CHAIN
	else if (nHeight <= 20)
        nSubsidy = 8400000 * COIN;	// Hold for develop and promotion
        else if (nHeight == 10000)
        nSubsidy = 10000 * COIN;      // SUPERBLOCK 10k
        else if (nHeight == 20000)
        nSubsidy = 20000 * COIN;      // SUPERBLOCK 20k
        else if (nHeight == 30000)
        nSubsidy = 30000 * COIN;      // SUPERBLOCK 30k
        else if (nHeight == 40000)
        nSubsidy = 40000 * COIN;      // SUPERBLOCK 40k
        else if (nHeight == 50000)
        nSubsidy = 50000 * COIN;      // SUPERBLOCK 50k
	else if (nHeight <= LAST_POW_BLOCK)
        nSubsidy = (100 + rand) * COIN;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "PUTINCOIN started 18.06.2016";
        CTransaction txNew;
        txNew.nTime = 1466258800;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1466258800;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 693980 : 693980;
...
//        assert(block.hashMerkleRoot == uint256("0xeb42ae0324ea968b5cdcd959104fc3b1cd93c45e25ba5be25b5e55deaf21254c"));
        assert(block.hashMerkleRoot == uint256("0x44aabca1d5ec200e1808f247ea8874a03153bee0e8a4dcb3599ca61d052d8ea0"));
    ...
    string strPubKey = "76355359bdb26700180e027cea73933d603dc74262eb27ed040fcf519c7373ad8b28294c06729a820b0ed6002ab0537c515d1e12d5d82838d2e46f64c8ae0223e5";
...
unsigned char pchMessageStart[4] = { 0x1a, 0x2c, 0x1b, 0x3c };
