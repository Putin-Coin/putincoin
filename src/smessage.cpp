...
// Copyright (c) 2015 The PutinCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("putincoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("putincoin-smsg-pow"); // Make this thread recognisable
